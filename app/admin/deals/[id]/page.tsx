    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-5 text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">Pool control</p>
      ...
      <section className="rounded-lg border border-amber-300/25 bg-amber-500/10 p-4">
        <div className="text-sm font-medium text-amber-100">Pool link</div>
        <div className="mt-2 flex flex-col gap-2 sm:flex-row">
          <input readOnly value={shareUrl} className="min-w-0 flex-1 rounded-md border border-amber-300/25 bg-white px-3 py-2 text-sm" />
